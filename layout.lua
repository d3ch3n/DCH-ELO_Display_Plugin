...
local function AddHeader()
  ...
  table.insert(graphics,{Type = "Image", Image = EloLogo, Position = {364,22}, Size = {112,38}})
...
local function AddDiagnostics(y)
  if PropIsYes("Enable Touch Control", true) then
    AddButton("TouchEnabled", 302, y, 80, 28, "Touch", ButtonGray, "Toggle")
    AddTextControl("TouchStatus", 390, y, 80, 28, "Textdisplay")
    y = y + 40
  end
  if PropIsYes("Enable Diagnostics", true) then
    AddButton("ReadStatus", 302, y, 80, 28, "Read", ButtonBlue)
    AddTextControl("CommandStatus", 390, y, 80, 28, "Textdisplay")
    AddText("TEMP", 302, y + 42, 80, 14, 8, "Left")
    AddTextControl("Temperature", 390, y + 38, 80, 22, "Textdisplay")
    AddText("POWER HRS", 302, y + 70, 80, 14, 8, "Left")
    AddTextControl("PowerHours", 390, y + 66, 80, 22, "Textdisplay")
    AddText("LIGHT HRS", 302, y + 98, 80, 14, 8, "Left")
    AddTextControl("BacklightHours", 390, y + 94, 80, 22, "Textdisplay")
  end
end
...
local function AddControlPage()
  ...
  AddGroupBox("STATUS", 292, 306, 190, 182)
  AddPowerBlock()
